...
forstmt : FOR forst cond forst DO st
          {
	    int label0, label1;
	    cptr *tmp;
...
label   : ID CRN
	    ...
	    $$.code = makecode(O_LAB, level - tmpl->l, tmpl->a);
	    $$.val = 0;
	  }
...
gotof   : GOTO ID SEMI
	    ...
	    $$.code = makecode(O_JMP, level - tmpl->l, tmpl->a);
	    $$.val = 0;
	  }
...
cond    : cond1
        ...
        | cond OR cond1
	  {
	    ...
	    $$.code = mergecode(tmp, makecode(O_LAB, 0, label3));
